...
export default function DeerModel(props: JSX.IntrinsicElements["group"]) {
  ...
  const controls = useControls("deer", {
    moveSpeed: 0.02,
    position: [-15, 0, 0],
    animation: {
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="AnimalArmature" userData={{ name: "AnimalArmature" }}>
          ...
          <group name="Deer" userData={{ name: "Deer" }}>
            <skinnedMesh
              name="Cube"
...
useGLTF.preload("/animals/Deer.gltf");
