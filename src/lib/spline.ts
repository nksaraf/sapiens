...
export function getSplineValue<T>(spline: SplinePoints<T>, t: number, lerpFn: LerpFn<T>): T {
  let p1 = 0;
...
export function getColorSplineValue(spline: SplinePoints<THREE.Color>, t: number): THREE.Color {
