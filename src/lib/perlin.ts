 ...
 */
export function pnoise1(x: number, px: number) {
  let ix0, ix1;
  let fx0, fx1;
  let s, n0, n1;
 ...
 */
export function pnoise2(x: number, y: number, px: number, py: number) {
  let ix0, iy0, ix1, iy1;
  let fx0, fy0, fx1, fy1;
  let s, t, nx0, nx1, n0, n1;
 ...
 */
export function pnoise3(x: number, y: number, z: number, px: number, py: number, pz: number) {
  let ix0, iy0, ix1, iy1, iz0, iz1;
  let fx0, fy0, fz0, fx1, fy1, fz1;
  let s, t, r;
  let nxy0, nxy1, nx0, nx1, n0, n1;
...
export function noise4(x: number, y: number, z: number, w: number) {
...
export function pnoise4(x: number, y: number, z: number, w: number,
...
export default function noise(x: any, y: any, z: any, w: any) {
